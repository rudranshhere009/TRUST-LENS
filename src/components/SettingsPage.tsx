...
export const SettingsPage = () => {
  ...
  const [language, setLanguage] = useStoredState("settings-language", i18n.language);
        ...
        <CardContent className="space-y-4 pt-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <Label htmlFor="email-notifications" className="flex flex-col space-y-1">
              ...
              <span className="font-normal leading-snug text-muted-foreground">
                {t('email_notifications_description')}              </span>
            </Label>
            <Switch
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <Label htmlFor="push-notifications" className="flex flex-col space-y-1">
              ...
              <span className="font-normal leading-snug text-muted-foreground">
                {t('push_notifications_description')}              </span>
            </Label>
            <Switch
      ...
      <Card className="dashboard-card-effect border-destructive/50">
        ...
        <CardContent className="pt-4">
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  {t('clear_cache_confirm_description')}
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            This will reset your application to its default state.
          </p>
        </CardContent>
      </Card>
