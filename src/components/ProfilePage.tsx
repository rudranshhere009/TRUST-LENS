        ...
        <CardContent className="space-y-6">
          <div className="flex items-center space-x-6">
            <Avatar className="h-24 w-24">
              ...
              <AvatarFallback>{localProfile.name.charAt(0).toUpperCase()}</AvatarFallback>
            </Avatar>
          ...
          <div className="space-y-2">
            ...
            <Input id="location" value={localProfile.location} onChange={handleChange} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="bio">Bio</Label>
            <Textarea id="bio" value={localProfile.bio} onChange={handleChange} placeholder="Tell us a little about yourself" />
          </div>
        </CardContent>
