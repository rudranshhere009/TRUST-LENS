...
const LoginPage = () => {
  ...
  return (
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden font-space-grotesk">
      <MatrixBackground />
      ...
      <main className="relative z-20 flex flex-col items-center justify-center text-center text-white p-4">
        <div className="relative z-10 max-w-md mx-auto rounded-xl bg-black/10 p-8 shadow-2xl shadow-green-500/30 backdrop-blur-xl border border-green-500/50 animate-scale-in animate-delay-300">
